...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-radius: 0; color: #000000; background-color: #201f42; background-image: url('images/Header-bg.png'); background-repeat: no-repeat; background-size: cover; width: 700px;" width="700">
<tbody>
<tr>
...
<div align="center" class="alignment" style="line-height:10px"><a href="{{url('http://update.b-smc.xyz/')}}" style="outline:none" tabindex="-1" target="_blank"><img alt="logo" src="{{asset($setting->logo)}}" style="display: block; height: auto; border: 0; width: 193px; max-width: 100%;" title="logo" width="193"/></a></div>
</td>
</tr>
</table>
</td>
...
<p style="margin: 0;">Bangabandhu Sheikh Mujib Chair</p>
</div>
</td>
</tr>
</table>
...
<h1 style="margin: 0; color: #201f42; direction: ltr; font-family: 'Noto Serif', Georgia, serif; font-size: 30px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Subscribe Alert</span></h1>
</td>
</tr>
</table>
...
<p style="margin: 0; margin-bottom: 0px;">Hello,</p>
<p style="margin: 0;"><br/>Thank you for subscribe us! we'll send a new publication information for your email.</p><br>
</div>
<p>Thanks and regards {!!$setting->address!!}</p>
<p>Fax: {{ $setting->fax }}</p>
...
<tr>
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" class="alignment" style="line-height:10px"><a href="{{url('http://update.b-smc.xyz/')}}" style="outline:none" tabindex="-1" target="_blank"><img alt="logo" src="{{asset($setting->logo)}}" style="display: block; height: auto; border: 0; width: 155px; max-width: 100%;" title="logo" width="155"/></a></div>
</td>
</tr>
</table>
</td>
...
<p style="margin: 0;">{{$setting->copyright}}</p>
</div>
</td>
</tr>
</table>
